# Contributing to stapel-mailtrap
...
```bash
git clone https://github.com/usestapel/stapel-mailtrap.git && cd stapel-mailtrap
...
- **No new hardcoded behavior.** Anything a host project might want to
  ...
  (`STAPEL_MAILTRAP` dict; see `conf.py`) — with a dotted-path
